...
import com.generation.blogpessoall.util.JwtHelper;
import com.generation.blogpessoall.util.TestBuilder;
...
public class UsuarioControllerTest {
	...
	void deveCadastrarUsuario() {
		//Given
		Usuario usuario = TestBuilder.criarUsuario(null, "Gabrielle Guimaraes",
				"gabrielle@email.com.br", "gabi1234");
	...
	void naoDeveCadastrarUsuarioDuplicdo(){
	...
	@Test
	@DisplayName("05 - Deve listar um usuário por ID")
	void deveListarUsuarioPorId() {

	    // Given
	    Usuario usuario = TestBuilder.criarUsuario(null, "Juliana",
	            "juliana@email.com.br", "juliana1234");
