...
1. Clone o repositório do Projeto [Blog Pessoal]https://github.com/julianaenob-hub/Blog_Pessoal.git dentro da pasta do *Workspace* do STS

```bash
git clone (https://github.com/julianaenob-hub/Blog_Pessoal.git)
```
...
Desenvolvido por [**Juliana**][https://github.com/julianaenob-hub/Blog_Pessoal.git)
